package kz.ermek.Project2SpringBoot.controllers;


import jakarta.validation.Valid;
import kz.ermek.Project2SpringBoot.models.Book;
import kz.ermek.Project2SpringBoot.models.Person;
import kz.ermek.Project2SpringBoot.services.BooksService;
...
public class BooksController {
    ...
    public String index(Model model, @RequestParam(value = "page", required = false) Integer page,
        ...
        if (page == null || booksPerPage == null){
            model.addAttribute("books", booksService.findAll(sortByYear)); //выдаем все книги
        } else {
